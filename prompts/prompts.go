...
First tool you should always call is bash tool to explore the current directory for files and determine the OS type so that you can use the appropriate commands for your environment.
